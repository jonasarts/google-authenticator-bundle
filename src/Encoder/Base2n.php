 ...
 *
 * @see        https://github.com/ademarre/binary-to-text-php
 *
...
namespace jonasarts\Bundle\GoogleAuthenticatorBundle\Encoder;
...
class Base2n
{
     ...
     * @param bool   $caseSensitive      To decode in a case-sensitive manner
     * @param bool   $_rightPadFinalBits How to encode last character
        ...
        bool $padFinalGroup = false, string $padCharacter = '=')
    {
        ...
        if ($bitsPerCharacter < 1) {
            ...
            $radix >>= 1;
            throw new InvalidArgumentException('$bitsPerCharacter can not be more than '.$bitsPerCharacter.' given $chars length of '.$charLength.' (max radix '.$radix.')');
     ...
     * @param bool   $strict        Returns NULL if $encodedString contains an undecodable character
     */
